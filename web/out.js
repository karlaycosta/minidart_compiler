...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1, playground, t2, t3, container, editor, _s4_ = "none";
      A.print("MiniDart Playground iniciado!");
      t1 = type$.String;
      t1 = A.LinkedHashMap_LinkedHashMap$_literal(["hello", 'importar io como saida;\n\nsaida.imprimir("Ol\xe1, MiniDart!");\nsaida.imprimir("Bem-vindo ao playground!");\n\nvar nome = "Desenvolvedor";\nsaida.imprimir("Ol\xe1, " + nome + "!");\n', "math", 'importar math;\nimportar io como saida;\n\nsaida.imprimir("=== Biblioteca Math ===");\n\nsaida.imprimir("Raiz quadrada de 16: " + math.sqrt(16));\nsaida.imprimir("2 elevado a 3: " + math.pow(2, 3));\nsaida.imprimir("Valor absoluto de -5: " + math.abs(-5));\nsaida.imprimir("Seno de \u03c0/2: " + math.sin(math.pi / 2));\nsaida.imprimir("N\xfamero aleat\xf3rio: " + math.random());\n', "string", 'importar string;\nimportar io como saida;\n\nsaida.imprimir("=== Biblioteca String ===");\n\nvar texto = "MiniDart \xe9 incr\xedvel!";\nsaida.imprimir("Texto original: " + texto);\nsaida.imprimir("Mai\xfascula: " + string.maiuscula(texto));\nsaida.imprimir("Min\xfascula: " + string.minuscula(texto));\nsaida.imprimir("Tamanho: " + string.tamanho(texto));\nsaida.imprimir("Substring (0,8): " + string.substring(texto, 0, 8));\n', "io", 'importar io como saida;\n\nsaida.imprimir("=== Entrada e Sa\xedda ===");\n\n// Exemplo de sa\xedda formatada\nsaida.escrever("Digite seu nome: ");\n// saida.lerLinha(); // N\xe3o funciona na web, apenas exemplo\n\nsaida.imprimir("\\nExemplo de formata\xe7\xe3o:");\nsaida.imprimir("N\xfamero: 42");\nsaida.imprimir("Decimal: 3.14159");\nsaida.imprimir("Booleano: " + verdadeiro);\n\nsaida.novaLinha();\nsaida.imprimir("Teste de I/O conclu\xeddo!");\n', "util", 'importar util;\nimportar io como saida;\n\nsaida.imprimir("=== Biblioteca Util ===");\n\n// Valida\xe7\xe3o\nsaida.imprimir("10 \xe9 par? " + util.ehPar(10));\nsaida.imprimir("7 \xe9 primo? " + util.ehPrimo(7));\n\n// Matem\xe1tica\nsaida.imprimir("Fatorial de 5: " + util.fatorial(5));\nsaida.imprimir("Fibonacci de 8: " + util.fibonacci(8));\nsaida.imprimir("MDC de 48 e 18: " + util.mdc(48, 18));\n\n// Convers\xe3o\nsaida.imprimir("Bin\xe1rio de 10: " + util.paraBinario(10));\nsaida.imprimir("Octal de 64: " + util.paraOctal(64));\n', "debug", 'importar io como saida;\n\nsaida.imprimir("=== Debug Avan\xe7ado ===");\n\nfuncao fibonacci(n) {\n    se (n <= 1) {\n        retornar n;\n    }\n    retornar fibonacci(n - 1) + fibonacci(n - 2);\n}\n\nvar resultado = fibonacci(10);\nsaida.imprimir("Fibonacci(10) = " + resultado);\n\n// Exemplo com loop\nsaida.imprimir("Contagem regressiva:");\npara (var i = 5; i > 0; i = i - 1) {\n    saida.imprimir("Tempo: " + i);\n}\nsaida.imprimir("Decolagem!");\n'], t1, t1);
      playground = new A.MiniDartPlayground(t1);
      t2 = document;
      t3 = type$.nullable_TextAreaElement._as(t2.querySelector("#editor"));
      if (t3 == null) {
        container = t2.querySelector("#editor-container");
        editor = t2.createElement("textarea");
        editor.id = "editor";
        editor.className = "fallback-editor";
        editor.placeholder = "Digite seu c\xf3digo MiniDart aqui...";
        t3 = editor.style;
        t3.width = "100%";
        t3 = editor.style;
        t3.height = "100%";
        t3 = editor.style;
        t3.fontFamily = "monospace";
        t3 = editor.style;
        t3.fontSize = "14px";
        t3 = editor.style;
        t3.border = _s4_;
        ...
        t3 = editor.style;
        t3.toString;
        B.CssStyleDeclaration_methods._setPropertyHelper$3(t3, B.CssStyleDeclaration_methods._browserPropertyName$1(t3, "resize"), _s4_, "");
        t3 = container == null;
        if (!t3)
      ...
      playground.__MiniDartPlayground__editor_A = t3;
      playground.__MiniDartPlayground__output_A = type$.DivElement._as(t2.querySelector("#output"));
      playground.__MiniDartPlayground__runButton_A = type$.ButtonElement._as(t2.querySelector("#run-btn"));
      playground.__MiniDartPlayground__exampleSelect_A = type$.SelectElement._as(t2.querySelector("#example-select"));
      playground.__MiniDartPlayground__status_A = type$.SpanElement._as(t2.querySelector("#status"));
      playground._setupEventListeners$0();
      t2 = playground.__MiniDartPlayground__editor_A;
      t1 = t1.$index(0, "hello");
      B.TextAreaElement_methods.set$value(t2, t1 == null ? "" : t1);
      playground._updateStats$0();
      playground._setupSharedCodeListener$0();
      B.SpanElement_methods.set$text(playground.__MiniDartPlayground__status_A, "Pronto para executar");
    },
    MiniDartPlayground: function MiniDartPlayground(t0) {
      var _ = this;
      _.__MiniDartPlayground__status_A = _.__MiniDartPlayground__exampleSelect_A = _.__MiniDartPlayground__runButton_A = _.__MiniDartPlayground__output_A = _.__MiniDartPlayground__editor_A = $;
      _._examples = t0;
    },
    MiniDartPlayground__setupSharedCodeListener_closure: function MiniDartPlayground__setupSharedCodeListener_closure(t0) {
      this.$this = t0;
    },
    MiniDartPlayground__setupEventListeners_closure: function MiniDartPlayground__setupEventListeners_closure(t0) {
      this.$this = t0;
    },
    MiniDartPlayground__setupEventListeners_closure0: function MiniDartPlayground__setupEventListeners_closure0(t0) {
      this.$this = t0;
    },
    MiniDartPlayground__setupEventListeners_closure1: function MiniDartPlayground__setupEventListeners_closure1(t0) {
      this.$this = t0;
    },
    MiniDartPlayground__setupEventListeners_closure2: function MiniDartPlayground__setupEventListeners_closure2(t0) {
      this.$this = t0;
    },
    MiniDartPlayground__setupEventListeners_closure3: function MiniDartPlayground__setupEventListeners_closure3(t0) {
      this.$this = t0;
    },
    MiniDartPlayground__setupEventListeners_closure4: function MiniDartPlayground__setupEventListeners_closure4(t0) {
      this.$this = t0;
    },
    MiniDartPlayground__setupEventListeners_closure5: function MiniDartPlayground__setupEventListeners_closure5(t0) {
      this.$this = t0;
    },
    MiniDartPlayground__setupEventListeners_closure6: function MiniDartPlayground__setupEventListeners_closure6(t0) {
      this.$this = t0;
    },
    MiniDartPlayground__setupEventListeners_closure7: function MiniDartPlayground__setupEventListeners_closure7(t0) {
      this.$this = t0;
    },
    MiniDartPlayground__shareCode_closure: function MiniDartPlayground__shareCode_closure(t0, t1) {
      this.$this = t0;
      this.url = t1;
    },
    MiniDartPlayground__shareCode_closure0: function MiniDartPlayground__shareCode_closure0(t0) {
      this.$this = t0;
    },
  ...
  A.MiniDartPlayground.prototype = {
    _setupSharedCodeListener$0() {
      var t1 = document;
      t1.toString;
      B.HtmlDocument_methods.addEventListener$2(t1, "loadSharedCode", new A.MiniDartPlayground__setupSharedCodeListener_closure(this));
    },
    _setupEventListeners$0() {
      var t2, t3, t4, t5, _this = this,
        t1 = _this.__MiniDartPlayground__runButton_A;
      t1 === $ && A.throwLateFieldNI("_runButton");
      t2 = type$._ElementEventStreamImpl_MouseEvent;
      A._EventStreamSubscription$(t1, "click", t2._eval$1("~(1)?")._as(new A.MiniDartPlayground__setupEventListeners_closure(_this)), false, t2._precomputed1);
      t2 = _this.__MiniDartPlayground__editor_A;
      t2 === $ && A.throwLateFieldNI("_editor");
      t1 = type$._ElementEventStreamImpl_KeyboardEvent;
      A._EventStreamSubscription$(t2, "keydown", t1._eval$1("~(1)?")._as(new A.MiniDartPlayground__setupEventListeners_closure0(_this)), false, t1._precomputed1);
      t1 = _this.__MiniDartPlayground__exampleSelect_A;
      t1 === $ && A.throwLateFieldNI("_exampleSelect");
      t2 = type$._ElementEventStreamImpl_Event;
      t3 = t2._eval$1("~(1)?");
      t2 = t2._precomputed1;
      A._EventStreamSubscription$(t1, "change", t3._as(new A.MiniDartPlayground__setupEventListeners_closure1(_this)), false, t2);
      t1 = document;
      t4 = t1.querySelector("#clear-btn");
      if (t4 != null) {
        t4 = J.get$onClick$x(t4);
        t5 = t4.$ti;
        A._EventStreamSubscription$(t4._target, t4._eventType, t5._eval$1("~(1)?")._as(new A.MiniDartPlayground__setupEventListeners_closure2(_this)), false, t5._precomputed1);
      }
      t4 = t1.querySelector("#clear-output-btn");
      if (t4 != null) {
        t4 = J.get$onClick$x(t4);
        t5 = t4.$ti;
        A._EventStreamSubscription$(t4._target, t4._eventType, t5._eval$1("~(1)?")._as(new A.MiniDartPlayground__setupEventListeners_closure3(_this)), false, t5._precomputed1);
      }
      A._EventStreamSubscription$(_this.__MiniDartPlayground__editor_A, "input", t3._as(new A.MiniDartPlayground__setupEventListeners_closure4(_this)), false, t2);
      t2 = t1.querySelector("#help-btn");
      if (t2 != null) {
        t2 = J.get$onClick$x(t2);
        t3 = t2.$ti;
        A._EventStreamSubscription$(t2._target, t2._eventType, t3._eval$1("~(1)?")._as(new A.MiniDartPlayground__setupEventListeners_closure5(_this)), false, t3._precomputed1);
      }
      t2 = t1.querySelector(".modal-close");
      if (t2 != null) {
        t2 = J.get$onClick$x(t2);
        t3 = t2.$ti;
        A._EventStreamSubscription$(t2._target, t2._eventType, t3._eval$1("~(1)?")._as(new A.MiniDartPlayground__setupEventListeners_closure6(_this)), false, t3._precomputed1);
      }
      t1 = t1.querySelector("#share-btn");
      if (t1 != null) {
        t1 = J.get$onClick$x(t1);
        t2 = t1.$ti;
        A._EventStreamSubscription$(t1._target, t1._eventType, t2._eval$1("~(1)?")._as(new A.MiniDartPlayground__setupEventListeners_closure7(_this)), false, t2._precomputed1);
      }
    },
    _runCode$0() {
      var $async$goto = 0,
      ...
      var $async$_runCode$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $async$self.__MiniDartPlayground__editor_A;
              t1 === $ && A.throwLateFieldNI("_editor");
              code0 = t1.value;
              code = code0 == null ? "" : code0;
              if (J.trim$0$s(code).length === 0) {
                t1 = $async$self.__MiniDartPlayground__output_A;
                t1 === $ && A.throwLateFieldNI("_output");
                B.DivElement_methods.setInnerHtml$1(t1, '<pre class="output-text">AVISO: Por favor, digite algum c\xf3digo antes de executar.</pre>');
                // goto return
                $async$goto = 1;
                break;
              }
              t1 = $async$self.__MiniDartPlayground__status_A;
              t1 === $ && A.throwLateFieldNI("_status");
              B.SpanElement_methods.set$text(t1, "Executando...");
              t1 = $async$self.__MiniDartPlayground__runButton_A;
              t1 === $ && A.throwLateFieldNI("_runButton");
              t1.disabled = true;
              $async$self._showLoading$1(true);
              $async$handler = 4;
              $async$goto = 7;
            ...
            case 8:
              ...
              t2 = $async$self.__MiniDartPlayground__output_A;
              t2 === $ && A.throwLateFieldNI("_output");
              B.DivElement_methods.setInnerHtml$1(t2, '<pre class="output-text">' + t1 + "</pre>");
              B.SpanElement_methods.set$text($async$self.__MiniDartPlayground__status_A, "Execu\xe7\xe3o conclu\xedda");
              $async$next.push(6);
              // goto finally
              $async$goto = 5;
              break;
            case 4:
              ...
              B.SpanElement_methods.set$text($async$self.__MiniDartPlayground__status_A, "Erro na execu\xe7\xe3o");
              $async$next.push(6);
              // goto finally
              $async$goto = 5;
              break;
            ...
            case 5:
              // finally
              $async$handler = 2;
              $async$self.__MiniDartPlayground__runButton_A.disabled = false;
              $async$self._showLoading$1(false);
    ...
    _compileAndRun$1(code) {
      return this._compileAndRun$body$MiniDartPlayground(code);
    },
    _compileAndRun$body$MiniDartPlayground(code) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue, output, errorReporter, lexer, tokens, parser, statements, analyzer, lines, line, match, result, e, t1, t2, _i, t3, t4, t5, exception;
            ...
            switch ($async$goto) {
              case 0:
                ...
                try {
                  ...
                  output._contents += "SUCESSO: C\xf3digo compilado com sucesso!\n";
                  output._contents += "INFO: Simulando execu\xe7\xe3o...\n";
                  if (B.JSString_methods.contains$1(code, "saida.imprimir")) {
                    lines = A._setArrayType(code.split("\n"), type$.JSArray_String);
                    for (t1 = lines, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
                      line = t1[_i];
                      t3 = line;
                      t4 = J.getInterceptor$asx(t3);
                      t5 = t4.get$length(t3);
                      if (0 > t5)
                        A.throwExpression(A.RangeError$range(0, 0, t4.get$length(t3), null, null));
                      if (A.stringContainsUnchecked(t3, "saida.imprimir(", 0)) {
                        match = A.RegExp_RegExp('saida\\.imprimir\\("([^"]+)"\\)').firstMatch$1(line);
                        if (match != null) {
                          t3 = match._match;
                          if (1 >= t3.length) {
                  ...
                  t1 = J.get$length$asx(result) === 0 ? "SUCESSO: C\xf3digo executado com sucesso (sem sa\xedda)" : result;
                  ...
                  e = A.unwrapException(exception);
                  t1 = A.S(e);
                  $async$returnValue = "ERRO: Erro de compila\xe7\xe3o: " + t1;
                  // goto return
                  $async$goto = 1;
                  break;
                }
    ...
    _updateStats$0() {
      var code, lines, t2,
        t1 = this.__MiniDartPlayground__editor_A;
      t1 === $ && A.throwLateFieldNI("_editor");
      code = t1.value;
      if (code == null)
        code = "";
    ...
    _showLoading$1(show) {
      ...
      if (show) {
        if (overlay != null)
          J.get$classes$x(overlay).add$1(0, "show");
      } else if (overlay != null)
        J.get$classes$x(overlay).remove$1(0, "show");
    },
    _shareCode$0() {
      var code, js, utils, url, e, code0, exception, _this = this,
        _s7_ = "_status",
        t1 = _this.__MiniDartPlayground__editor_A;
      t1 === $ && A.throwLateFieldNI("_editor");
      code0 = t1.value;
      code = code0 == null ? "" : code0;
      if (J.trim$0$s(code).length === 0) {
        t1 = _this.__MiniDartPlayground__status_A;
        t1 === $ && A.throwLateFieldNI(_s7_);
        B.SpanElement_methods.set$text(t1, "N\xe3o h\xe1 c\xf3digo para compartilhar");
        return;
      }
      try {
        t1 = window;
        t1.toString;
        js = t1;
        utils = J.$index$asx(js, "MiniDartUtils");
        if (utils != null && utils.isReady$0()) {
          url = utils.generateShareUrl$1(code);
          utils.copyToClipboard$1(url).then$1(new A.MiniDartPlayground__shareCode_closure(_this, url)).catchError$1(new A.MiniDartPlayground__shareCode_closure0(_this));
        } else {
          t1 = _this.__MiniDartPlayground__status_A;
          t1 === $ && A.throwLateFieldNI(_s7_);
          B.SpanElement_methods.set$text(t1, "Aguarde - sistema de compartilhamento carregando...");
        }
      } catch (exception) {
        e = A.unwrapException(exception);
        t1 = _this.__MiniDartPlayground__status_A;
        t1 === $ && A.throwLateFieldNI(_s7_);
        B.SpanElement_methods.set$text(t1, "Erro ao compartilhar c\xf3digo");
        A.print("Erro de compartilhamento: " + A.S(e));
      }
    }
  };
  A.MiniDartPlayground__setupSharedCodeListener_closure.prototype = {
    call$1($event) {
      var t1, t2,
        detail = B.CustomEvent_methods.get$detail(type$.CustomEvent._as(type$.Event._as($event)));
      if (detail != null && J.$index$asx(detail, "code") != null) {
        t1 = this.$this;
        t2 = t1.__MiniDartPlayground__editor_A;
        t2 === $ && A.throwLateFieldNI("_editor");
        B.TextAreaElement_methods.set$value(t2, A._asStringQ(J.$index$asx(detail, "code")));
        t1._updateStats$0();
        t1 = t1.__MiniDartPlayground__status_A;
        t1 === $ && A.throwLateFieldNI("_status");
        B.SpanElement_methods.set$text(t1, "C\xf3digo compartilhado carregado");
      }
    },
    $signature: 29
  };
  A.MiniDartPlayground__setupEventListeners_closure.prototype = {
    call$1(__wc0_formal) {
  ...
  A.MiniDartPlayground__setupEventListeners_closure0.prototype = {
    call$1($event) {
      var t1;
  ...
  A.MiniDartPlayground__setupEventListeners_closure1.prototype = {
    call$1(__wc1_formal) {
      var selectedValue, t3,
        t1 = this.$this,
        t2 = t1.__MiniDartPlayground__exampleSelect_A;
      t2 === $ && A.throwLateFieldNI("_exampleSelect");
      selectedValue = t2.value;
      if (selectedValue != null && selectedValue.length !== 0) {
        t2 = t1.__MiniDartPlayground__editor_A;
        t2 === $ && A.throwLateFieldNI("_editor");
        t3 = t1._examples.$index(0, selectedValue);
        B.TextAreaElement_methods.set$value(t2, t3 == null ? "" : t3);
        t1._updateStats$0();
        t1 = t1.__MiniDartPlayground__status_A;
        t1 === $ && A.throwLateFieldNI("_status");
        B.SpanElement_methods.set$text(t1, "Exemplo carregado: " + selectedValue);
      }
      return null;
    },
    $signature: 11
  };
  A.MiniDartPlayground__setupEventListeners_closure2.prototype = {
    call$1(__wc2_formal) {
      var t1, t2;
  ...
  A.MiniDartPlayground__setupEventListeners_closure3.prototype = {
    call$1(__wc3_formal) {
      var t1;
      type$.MouseEvent._as(__wc3_formal);
      t1 = this.$this.__MiniDartPlayground__output_A;
      t1 === $ && A.throwLateFieldNI("_output");
      B.DivElement_methods.setInnerHtml$1(t1, '      <div class="welcome-message">\n        <h4>Sa\xedda limpa</h4>\n        <p>Execute seu c\xf3digo para ver o resultado aqui.</p>\n      </div>\n    ');
      return null;
    },
    $signature: 5
  };
  A.MiniDartPlayground__setupEventListeners_closure4.prototype = {
    call$1(__wc4_formal) {
      return this.$this._updateStats$0();
    },
    $signature: 11
  };
  A.MiniDartPlayground__setupEventListeners_closure5.prototype = {
    call$1(__wc5_formal) {
      var t1;
      type$.MouseEvent._as(__wc5_formal);
      t1 = document.querySelector("#help-modal");
      if (t1 != null)
        J.get$classes$x(t1).add$1(0, "show");
      return null;
    },
    $signature: 5
  };
  A.MiniDartPlayground__setupEventListeners_closure6.prototype = {
    call$1(__wc6_formal) {
      var t1;
      type$.MouseEvent._as(__wc6_formal);
      t1 = document.querySelector("#help-modal");
      if (t1 != null)
        J.get$classes$x(t1).remove$1(0, "show");
      return null;
    },
    $signature: 5
  };
  A.MiniDartPlayground__setupEventListeners_closure7.prototype = {
    call$1(__wc7_formal) {
      type$.MouseEvent._as(__wc7_formal);
      return this.$this._shareCode$0();
    },
    $signature: 5
  };
  A.MiniDartPlayground__shareCode_closure.prototype = {
    call$1(success) {
      var t1 = this.$this.__MiniDartPlayground__status_A;
      if (success) {
        t1 === $ && A.throwLateFieldNI("_status");
        B.SpanElement_methods.set$text(t1, "Link copiado para o clipboard!");
      } else {
        t1 === $ && A.throwLateFieldNI("_status");
        B.SpanElement_methods.set$text(t1, "Link gerado - verifique o console");
        A.print("Share URL: " + A.S(this.url));
      }
    },
    $signature: 7
  };
  A.MiniDartPlayground__shareCode_closure0.prototype = {
    call$1(error) {
      var t1 = this.$this.__MiniDartPlayground__status_A;
      t1 === $ && A.throwLateFieldNI("_status");
      B.SpanElement_methods.set$text(t1, "Erro ao copiar link");
      A.print("Clipboard error: " + A.S(error));
    },
    $signature: 7
  };
  ...
  A.Parser.prototype = {
    ...
    _declaration$0() {
      ...
      try {
        ...
        if (_this._parser$_match$1(A._setArrayType([B.TokenType_42], t1))) {
          t1 = _this._varDeclaration$0();
          return t1;
        }
        if (_this._parser$_match$1(A._setArrayType([B.TokenType_59], t1))) {
          t1 = _this._tokens;
    ...
    _varDeclaration$0() {
      var _this = this,
        ...
        initializer = _this._parser$_match$1(A._setArrayType([B.TokenType_18], type$.JSArray_TokenType)) ? _this._assignment$0() : null;
    ...
    _statement$0() {
      var t2, t3, library, alias, condition, thenBranch, value, body, t4, keyword, _this = this,
        ...
        t1 = type$.JSArray_TokenType;
      if (_this._parser$_match$1(A._setArrayType([B.TokenType_60], t1))) {
        t2 = _this._tokens;
        ...
        alias = _this._parser$_match$1(A._setArrayType([B.TokenType_61], t1)) ? _this._consume$2(B.TokenType_29, "Esperado nome do alias ap\xf3s 'como'.") : null;
        _this._consume$2(B.TokenType_11, "Esperado ';' ap\xf3s declara\xe7\xe3o de import.");
        return new A.ImportStmt(library, alias);
      }
      if (_this._parser$_match$1(A._setArrayType([B.TokenType_36], t1))) {
        ...
        return new A.IfStmt(condition, thenBranch, _this._parser$_match$1(A._setArrayType([B.TokenType_33], t1)) ? _this._statement$0() : null);
      }
      if (_this._parser$_match$1(A._setArrayType([B.TokenType_39], t1))) {
        value = _this._assignment$0();
        _this._consume$2(B.TokenType_11, "Esperado ';' ap\xf3s o valor.");
        return new A.PrintStmt(value);
      }
      if (_this._parser$_match$1(A._setArrayType([B.TokenType_43], t1))) {
      ...
      if (_this._parser$_match$1(A._setArrayType([B.TokenType_50], t1))) {
      ...
      if (_this._parser$_match$1(A._setArrayType([B.TokenType_35], t1))) {
        t1 = _this._tokens;
        t2 = _this._parser$_current;
        if (!(t2 < t1.length))
          return A.ioore(t1, t2);
      ...
      if (_this._parser$_match$1(A._setArrayType([B.TokenType_40], t1))) {
        t1 = _this._tokens;
        t2 = _this._parser$_current;
        t3 = t2 - 1;
        t4 = t1.length;
      ...
      if (_this._parser$_match$1(A._setArrayType([B.TokenType_44], t1))) {
        t1 = _this._tokens;
      ...
      if (_this._parser$_match$1(A._setArrayType([B.TokenType_45], t1))) {
        t1 = _this._tokens;
        t2 = _this._parser$_current - 1;
        if (!(t2 >= 0 && t2 < t1.length))
          return A.ioore(t1, t2);
      ...
      if (_this._parser$_match$1(A._setArrayType([B.TokenType_46], t1)))
        return _this._switchStatement$0();
      if (_this._parser$_match$1(A._setArrayType([B.TokenType_2], t1)))
    ...
    _forStatement$0() {
      ...
      condition = _this._assignment$0();
      t1 = type$.JSArray_TokenType;
      if (_this._parser$_match$1(A._setArrayType([B.TokenType_51], t1))) {
      ...
      } else if (_this._parser$_match$1(A._setArrayType([B.TokenType_52], t1))) {
        step = _this._assignment$0();
    ...
    _forCStatement$0() {
      ...
      t1 = type$.JSArray_TokenType;
      if (_this._parser$_match$1(A._setArrayType([B.TokenType_11], t1)))
        initializer = null;
      else if (_this._parser$_match$1(A._setArrayType([B.TokenType_42], t1)))
    ...
    _assignment$0() {
      var t2, equals, value, operator, _this = this,
        ...
        t1 = type$.JSArray_TokenType;
      if (_this._parser$_match$1(A._setArrayType([B.TokenType_18], t1))) {
        t1 = _this._tokens;
        t2 = _this._parser$_current - 1;
        if (!(t2 >= 0 && t2 < t1.length))
          return A.ioore(t1, t2);
      ...
      } else if (_this._parser$_match$1(A._setArrayType([B.TokenType_20, B.TokenType_21, B.TokenType_22, B.TokenType_23, B.TokenType_24], t1))) {
        t1 = _this._tokens;
        t2 = _this._parser$_current - 1;
        if (!(t2 >= 0 && t2 < t1.length))
          return A.ioore(t1, t2);
    ...
    _ternary$0() {
      ...
      if (_this._parser$_match$1(A._setArrayType([B.TokenType_14], t1))) {
    ...
    _unary$0() {
      var t2, expr, _this = this,
        t1 = type$.JSArray_TokenType;
      if (_this._parser$_match$1(A._setArrayType([B.TokenType_16, B.TokenType_6, B.TokenType_62], t1))) {
        t1 = _this._tokens;
        t2 = _this._parser$_current - 1;
        if (!(t2 >= 0 && t2 < t1.length))
          return A.ioore(t1, t2);
      ...
      if (_this._parser$_match$1(A._setArrayType([B.TokenType_9], t1))) {
        expr = _this._call$0();
        if (expr instanceof A.VariableExpr)
      ...
      if (_this._parser$_match$1(A._setArrayType([B.TokenType_8], t1))) {
        expr = _this._call$0();
        if (expr instanceof A.VariableExpr)
    ...
    _call$0() {
      ...
      for (t1 = type$.JSArray_TokenType, t2 = _this._tokens; true;)
        if (_this._parser$_match$1(A._setArrayType([B.TokenType_0], t1)))
          expr = _this._finishCall$1(expr);
        else if (_this._parser$_match$1(A._setArrayType([B.TokenType_5], t1))) {
          t3 = _this._parser$_current - 1;
          if (!(t3 >= 0 && t3 < t2.length))
            return A.ioore(t2, t3);
          _this._consume$2(B.TokenType_29, "Esperado nome da propriedade ap\xf3s '.'.");
          expr = new A.MemberAccessExpr(expr);
        } else if (_this._parser$_match$1(A._setArrayType([B.TokenType_8], t1)))
          if (expr instanceof A.VariableExpr)
            expr = new A.IncrementExpr(expr.name);
          else
            throw A.wrapException(_this._error$2(_this._parser$_previous$0(), string$.Operadx2b));
        else if (_this._parser$_match$1(A._setArrayType([B.TokenType_9], t1)))
          if (expr instanceof A.VariableExpr)
    ...
    _parser$_primary$0() {
      var t2, expr, _this = this,
        t1 = type$.JSArray_TokenType;
      if (_this._parser$_match$1(A._setArrayType([B.TokenType_34], t1)))
        return new A.LiteralExpr(false);
      if (_this._parser$_match$1(A._setArrayType([B.TokenType_41], t1)))
        return new A.LiteralExpr(true);
      if (_this._parser$_match$1(A._setArrayType([B.TokenType_37], t1)))
        return new A.LiteralExpr(null);
      if (_this._parser$_match$1(A._setArrayType([B.TokenType_31, B.TokenType_30], t1))) {
        t1 = _this._tokens;
        t2 = _this._parser$_current - 1;
        if (!(t2 >= 0 && t2 < t1.length))
          return A.ioore(t1, t2);
      ...
      if (_this._parser$_match$1(A._setArrayType([B.TokenType_29], t1))) {
        t1 = _this._tokens;
        t2 = _this._parser$_current - 1;
        if (!(t2 >= 0 && t2 < t1.length))
          return A.ioore(t1, t2);
    ...
    _binary$2$next$types(next, types) {
      ...
      expr = next.call$0();
      for (t1 = this._tokens; this._parser$_match$1(types);) {
    ...
    _functionDeclaration$0() {
      ...
      if (!(t2 !== B.TokenType_63 && t2 === B.TokenType_1)) {
        ...
        } while (_this._parser$_match$1(A._setArrayType([B.TokenType_4], t2)));
      }
    ...
    _switchStatement$0() {
      ...
      while (true) {
        ...
        if (!(!(t5 && t4 === B.TokenType_3) && t5))
          break;
        if (_this._parser$_match$1(A._setArrayType([B.TokenType_47], t3))) {
        ...
        } else if (_this._parser$_match$1(A._setArrayType([B.TokenType_48], t3))) {
          t4 = _this._parser$_current - 1;
          if (!(t4 >= 0 && t4 < t1.length))
            return A.ioore(t1, t4);
  ...
  A.StandardLibrary__registerDataLibrary_closure10.prototype = {
    call$1(args) {
      var t1 = new A.DateTime(A.DateTime__validate(this.$this._toInt$1(J.$index$asx(type$.List_nullable_Object._as(args), 0)) * 1000, 0, false), 0, false).toString$0(0).split(" ");
      if (0 >= t1.length)
        return A.ioore(t1, 0);
      return t1[0];
    },
  ...
  (function installTearOffs() {
    ...
    _static(A, "html__Html5NodeValidator__standardAttributeValidator$closure", 4, null, ["call$4"], ["_Html5NodeValidator__standardAttributeValidator"], 17, 0);
    _static(A, "html__Html5NodeValidator__uriAttributeValidator$closure", 4, null, ["call$4"], ["_Html5NodeValidator__uriAttributeValidator"], 17, 0);
    var _;
    _instance_0_u(_ = A.Parser.prototype, "get$_and", "_and$0", 6);
    _instance_0_u(_, "get$_equality", "_equality$0", 6);
    _instance_0_u(_, "get$_comparison", "_comparison$0", 6);
    _instance_0_u(_, "get$_term", "_term$0", 6);
    _instance_0_u(_, "get$_factor", "_factor$0", 6);
    _instance_0_u(_, "get$_unary", "_unary$0", 6);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.SentinelValue, A.Iterable, A.ListIterator, A.MappedIterator, A.WhereIterator, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.Closure, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.JSSyntaxRegExp, A._MatchImplementation, A.StringMatch, A._StringAllMatchesIterator, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A._StreamIterator, A._Zone, A.SetBase, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A.DateTime, A.Duration, A._Enum, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.Null, A._StringStackTrace, A.StringBuffer, A.CssStyleDeclarationBase, A.EventStreamProvider, A._EventStreamSubscription, A._Html5NodeValidator, A.ImmutableListMixin, A.NodeValidatorBuilder, A._SimpleNodeValidator, A._SvgNodeValidator, A.FixedSizeListIterator, A._SameOriginUriPolicy, A._ValidatingTreeSanitizer, A._AcceptStructuredClone, A.NullRejectionException, A._JSRandom, A.Stmt, A.TypeInfo, A.Parameter, A.CaseStmt, A.Expr, A.ErrorReporter, A.Lexer, A.MiniDartPlayground, A.Parser, A.SemanticAnalyzer, A.NativeFunction, A.StandardLibrary, A.Symbol, A.SymbolTable, A.Token]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JavaScriptBigInt, J.JavaScriptSymbol, J.JSNumber, J.JSString]);
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.EventTarget, A._CssStyleDeclaration_JavaScriptObject_CssStyleDeclarationBase, A.Event, A.DomException, A.DomImplementation, A.DomTokenList, A._HtmlCollection_JavaScriptObject_ListMixin, A.Location, A._NodeList_JavaScriptObject_ListMixin, A.__NamedNodeMap_JavaScriptObject_ListMixin]);
    ...
    _inheritMany(A.Event, [A.CustomEvent, A.UIEvent]);
  ...
  (function constants() {
    ...
    B.CustomEvent_methods = A.CustomEvent.prototype;
